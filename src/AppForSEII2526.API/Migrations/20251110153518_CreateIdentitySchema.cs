    ...
    public partial class CreateIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AccountCreationDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExtraReward = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DeliveryAssignmentDone = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_DeliveryDrivers_DeliveryDriverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryAssignmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseDeliveries", x => new { x.DeliveryAssignmentId, x.PurchaseOrderId });
                    table.ForeignKey(
                        name: "FK_PurchaseDeliveries_DeliveryAssignments_DeliveryAssignmentId",
                        column: x => x.DeliveryAssignmentId,
                        principalTable: "DeliveryAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseDeliveries_PurchaseOrders_PurchaseOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Name_Surname_Address_AccountCreationDate",
                table: "AspNetUsers",
                columns: new[] { "Name", "Surname", "Address", "AccountCreationDate" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_DeliveryDriverId",
                table: "DeliveryAssignments",
                column: "DeliveryDriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryDrivers_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDeliveries_PurchaseOrderId",
